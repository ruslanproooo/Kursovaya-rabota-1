...
<body>
    ...
    <div class="main-container">
        <div class="car-block">
            <img src="BMW-3.jpg" width="150" height="150" alt="Car 1">
            <p>Название авто 1</p>
            <p>Пробег: 10000 км</p>
            <p>Год выпуска: 2020</p>
            <p>Состояние: Идеальное</p>
            <a href="BMW3.php"><button>Подробнее</button></a>
        </div>
        
        <div class="car-block">
            <img src="BMW-5.jpg" width="150" height="150" alt="Car 2">
            <p>Название авто 2</p>
            <p>Пробег: 20000 км</p>
        ...
        <div class="car-block">
            <img src="BMW-X5.jpg" width="150" height="150" alt="Car 3">
            <p>Название авто 3</p>
            <p>Пробег: 15000 км</p>
